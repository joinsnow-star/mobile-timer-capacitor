...
Java Development Kit (JDK) (OpenJDK 11 或更高版本)

Android Studio (包含 Android SDK)

配置好 JAVA_HOME 和 Android SDK 相关的环境变量 (ANDROID_SDK_ROOT 或 ANDROID_HOME, 并将 platform-tools 和 cmdline-tools/tools 加入 PATH)。
